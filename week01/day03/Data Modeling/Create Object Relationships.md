...
For Label, enter FavoriteCopy.
For Plural Label, enter FavoritesCopy.
...
Click Next.
For Field Name, enter ContactCopy, then click Next.
Click Next, Next, and Save.
...
Click Next.
For Field Name, enter PropertyCopy and click Next.
Click Next, Next, and Save.
